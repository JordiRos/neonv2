...
//
//---------------------------------------------------------------------------//
void CFilterDist::SetTime(float fTime)
{
...
//
//---------------------------------------------------------------------------//
bool CFilterDist::Apply(CDisplayDevice *pDD, int iTexSrc, int iTexTgt)
{
  switch (m_iType)
  {
    case DIST_CRYSTAL:     DrawCrystal    (pDD, iTexSrc, iTexTgt); break;
    case DIST_CIRCCRYSTAL: DrawCircCrystal(pDD, iTexSrc, iTexTgt); break;
    case DIST_SIN:         DrawSin        (pDD, iTexSrc, iTexTgt); break;
    case DIST_POLAR:       DrawPolar      (pDD, iTexSrc, iTexTgt); break;
  }
  return true;
}
...
//
//---------------------------------------------------------------------------//
void CFilterDist::DrawCrystal(CDisplayDevice *pDD, int iTexSrc, int iTexTgt)
{
  ...
  g_pGestorMateriales->SetTextura(iTexSrc, 0);
...
//
//---------------------------------------------------------------------------//
void CFilterDist::DrawCircCrystal(CDisplayDevice *pDD, int iTexSrc, int iTexTgt)
{
  D3DDEVICE *pD3D = pDD->GetD3DDevice();
  float fTime = m_fTime * m_fSpeed;
...
//
//---------------------------------------------------------------------------//
void CFilterDist::DrawSin(CDisplayDevice *pDD, int iTexSrc, int iTexTgt)
{
  D3DDEVICE *pD3D = pDD->GetD3DDevice();
  float fTime = m_fTime * m_fSpeed;
...
//
//---------------------------------------------------------------------------//
void CFilterDist::DrawPolar(CDisplayDevice *pDD, int iTexSrc, int iTexTgt)
{
  D3DDEVICE *pD3D = pDD->GetD3DDevice();
  float fTime = m_fTime * m_fSpeed;
